...
class HighScoreCategory:
    ...
    # adding in the 'lowest_score' option TNA created
    lowest_score = False
...
class CategoryDrivenDataHelper:
    ...
    def add_placeholder(self, category, score, name):
        ...
        if not low_score:
            ...
            category.scores = sorted(category.scores, reverse=False) # Sort from low to high
    ...
    def prompts(self):
        ...
        for category in self.categories:
            for player in self.game.players:
                self.data.add_placeholder(category=category, score=category.score_for_player(player),
                                          name=player.name.upper(), low_score=category.lowest_score)
