...
class Attract(game.Mode):
	...
	def __init__(self, game):
		...
		self.press_start = dmd.TextLayer(128/2, 7, self.game.font_jazz18, "center").set_text("Press Enter")
		self.proc_banner = dmd.TextLayer(128/2, 7, self.game.font_jazz18, "center").set_text("pyprocgame")
...
class TestGame(game.BasicGame):
	...
	def __init__(self, machine_type):
		...
		self.font_tiny7 = dmd.Font(fonts_path+"04B-03-7px.dmd")
		self.font_jazz18 = dmd.Font(fonts_path+"Jazz18-18px.dmd")
		self.dmd = dmd.DisplayController(self, width=128, height=32, message_font=self.font_tiny7)
	...
	def setup(self):
		...
		self.service_mode = procgame.service.ServiceMode(self,100,self.font_tiny7)
		self.reset()
