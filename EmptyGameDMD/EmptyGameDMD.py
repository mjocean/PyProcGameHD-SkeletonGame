##########################
# this is intended to be a very simple game using a physical
# monochrome DMD driven by the P-ROC controller from which
...
class MyGame(SkeletonGame):
    ...
    def displayText(self, msg, background_layer=None, font_key=None, font_style=None, opaque=True, duration=2.0, flashing=False):
        # change default to opaque when using a physical monochrome DMD
        super(MyGame, self).displayText(msg, background_layer, font_key, font_style, opaque, duration, flashing)
